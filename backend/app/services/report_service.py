...
class ReportService:
    ...
    def generate_threat_pdf(threat_data: Dict[str, Any], investigator_name: str = "Chief Security Investigator") -> bytes:
        ...
        header_data = [
            [
                Paragraph("<b>VAULTSHIELD</b> AI THREAT FORENSICS", title_style),
        ...
        footer_text = f"Report generated by VaultShield Security SOC Platform on behalf of {investigator_name}. SIH 2026."
