  ...
  return (
    <div className="space-y-6 animate-fade-in font-body">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#192837]/10 shadow-xs space-y-5">
        ...
        {/* Automated Background Sentinel Bar */}
        <div className="p-4 rounded-2xl bg-[#FAF9F6] border border-[#192837]/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
