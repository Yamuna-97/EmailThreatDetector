        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#7342E2]/10 border border-[#7342E2]/20 mb-5 shadow-xs"
            >
            ...
            <motion.div
              ...
              animate="visible"
              variants={fadeUpVariant}
              className="text-base sm:text-lg font-semibold text-[#7342E2] mb-4 min-h-[28px] flex items-center gap-2"
            >
          ...
          {/* Right Column: Interactive Telemetry Card with Card Component */}
